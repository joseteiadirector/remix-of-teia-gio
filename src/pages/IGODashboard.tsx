  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-background">
      ...
      <Tabs defaultValue="convergence" className="space-y-8">
        <TabsList className="grid w-full grid-cols-3 !bg-transparent p-0 gap-3 h-auto">
          <TabsTrigger value="convergence" className="!bg-slate-800/90 data-[state=active]:!bg-gradient-to-r data-[state=active]:from-emerald-500 data-[state=active]:to-green-400 data-[state=active]:text-white data-[state=active]:shadow-[0_0_25px_rgba(16,185,129,0.6)] data-[state=inactive]:text-slate-300 data-[state=inactive]:border data-[state=inactive]:border-slate-600/50 rounded-xl py-4 px-6 font-black text-base transition-all duration-300 hover:!bg-emerald-500/30 hover:text-emerald-200">
            Convergência Cognitiva
          </TabsTrigger>
          <TabsTrigger value="coherence" className="!bg-slate-800/90 data-[state=active]:!bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-violet-400 data-[state=active]:text-white data-[state=active]:shadow-[0_0_25px_rgba(168,85,247,0.6)] data-[state=inactive]:text-slate-300 data-[state=inactive]:border data-[state=inactive]:border-slate-600/50 rounded-xl py-4 px-6 font-black text-base transition-all duration-300 hover:!bg-purple-500/30 hover:text-purple-200">
            Matriz de Coerência
          </TabsTrigger>
          <TabsTrigger value="consensus" className="!bg-slate-800/90 data-[state=active]:!bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-blue-400 data-[state=active]:text-white data-[state=active]:shadow-[0_0_25px_rgba(6,182,212,0.6)] data-[state=inactive]:text-slate-300 data-[state=inactive]:border data-[state=inactive]:border-slate-600/50 rounded-xl py-4 px-6 font-black text-base transition-all duration-300 hover:!bg-cyan-500/30 hover:text-cyan-200">
            Consenso Multi-LLM
          </TabsTrigger>
        </TabsList>
